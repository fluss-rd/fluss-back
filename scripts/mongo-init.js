...
const locationYaqueDelNorteRiver = [
    {
...
db.modules.insertOne({
    ...
    serial: "1-111111111",
    location: {
        latitude: 17.747669332363955,
        longitude: -71.37628803640717,
    }
})
...
db.modules.insertOne({
    ...
    serial: "1-222222222",
    location: {
        latitude: 17.728628027710965,
        longitude: -71.37617959389283,
    }
})
...
db.modules.insertOne({
    ...
    serial: "1-33333333",
    location: {
        latitude: 17.78560587352489,
        longitude: -71.36028321504891,
    }
})
...
db.modules.insertOne({
    ...
    serial: "2-111111111",
    location: {
        latitude: 19.670671870956927,
        longitude: -71.40248618687652,
    }
})
...
db.modules.insertOne({
    ...
    serial: "2-222222222",
    location: {
        latitude: 19.688509382057877,
        longitude: -71.4003433581485,
    }
})
