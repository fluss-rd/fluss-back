...
type AppConfig struct {
	Environment string `yaml:"environment" validate:"required" env:"ENVIRONMENT,required"`
	...
	DatabaseConfig struct {
		...
		DatabaseName string `yaml:"databaseName" validate:"required" env:"DATABASENAME,required"`
	} `yaml:"databaseConfig"`
}
